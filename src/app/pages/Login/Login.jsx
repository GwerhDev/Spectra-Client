  ...
  return (
    <div className={s.container}>
      ...
      <div className={s.welcomeCont} id='welcomeCont'>
        ...
        <LoginNhexa />
        <br />
        <p className='family-poppins'>¿No tienes una cuenta? <a className={s.linkHub} href={`${URL_NHEXA_ACCOUNTS}/register?callback=${encodeURIComponent(URL_CLIENT)}`}>Regístrate</a></p>
      </div>
    </div>
  )
}
